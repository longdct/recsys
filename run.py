...
def parse_args():
    ...
    parser.add_argument("--lam", type=float, default=0.5, help="Regularization factor")
...
def main():
    ...
    print(f"Train RMSE: {mf.score(df_train, bound=bound)}")
    # print(f"Valid RMSE: {mf.score(df_valid, bound=bound)}")
    print(f"Test RMSE: {mf.score(df_test, bound=bound)}")
